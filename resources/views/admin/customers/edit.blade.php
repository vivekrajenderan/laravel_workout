        ...
        <div class="page-title">
            ...
            <div class="title_right">
                <div class="pull-right">
                    <a href="<?php echo url('/admin/user/'); ?>" class="btn btn-default" >User List</a>
                </div>
            </div>
        </div>
            ...
            <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel">
                    ...
                    <div class="x_content">
                        ...
                        <form  class="form-horizontal form-label-left" method="post" autocomplete="off" id="user-form" action="<?php echo url('/admin/user/ajax-edit'); ?>">
